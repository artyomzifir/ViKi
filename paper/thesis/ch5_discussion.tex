...
\begin{enumerate}[leftmargin=2em]
  \item \emph{Landmark detection noise.} Error in the image-plane hand
        ...
        reduced by multi-view triangulation \eqref{eq:triangulate}, which
        constrains the point by camera geometry instead of averaging per-view
        depth lifts, and it is characterised by the wrist-position repeatability
