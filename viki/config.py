...
RETARGET_ADAPTER_TRANSLATION_MM: list[float]
RETARGET_ADAPTER_RPY_DEG: list[float]
RETARGET_ADAPTER_RADIUS_MM: float
...
_DEFAULTS: dict[str, Any] = {
    ...
    "RETARGET_ADAPTER_TRANSLATION_MM": [0.0, 0.0, 11.0],
