"""
viki.perception.detectors.composite
---------------------------------
Aggregates N PartialLandmarkDetector instances into one HandDetection per
frame in the global N-slot layout (default n_slots = HAND_LM_COUNT = 21).
"""
...
from viki.perception.models import HAND_LM_COUNT, HandDetection, LM, PreparedFrame
...
class CompositeLandmarkDetector:
    ...
    def __init__(
        ...
        mode : FusionMode, default=FusionMode.ANY
            Fusion strategy.
        n_slots : int, default=HAND_LM_COUNT
